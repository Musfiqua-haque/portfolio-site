...
export default function About() {
  return (
    <div className='a row'>
       <div className="a-left mt-5 col-sm-12 col-md-12 col-lg-6">
        <div className="a-card bg"></div>
            <div className="a-card">
                <img className='a-img' src={myself} alt="" />
            </div>
       </div>
       <div className="a-right col-sm-12 col-md-12 col-lg-6">
            <h1 className="a-title text-center mt-5">About Me</h1>
            <p className="sub mt-5">Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum has been the industry's standard dummy text.Lorem Ipsum has been the industry's standard dummy text. </p>
